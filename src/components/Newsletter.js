...
const Newsletter = () => {
  ...
  return (
    <div className='bg-none lg:bg-newsletter lg:bg-cover lg:h-[220px] lg:bg-center lg:px-24 xl:bg-auto' name="newsletter">
      <div className='flex flex-col lg:flex-row justify-between items-center h-full'>
        {/* title & subtitle */}
        <div className='text-center lg:text-left mb-4'>
          <h3 className='text-[26px] font-primary italic text-white mb-2'>
            {title}
          </h3>
          <p>{subtitle}</p>
        </div>
